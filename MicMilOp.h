...
enum IL_op
{
    ...
    IL_div, IL_dup, IL_ldarg, IL_ldarg_s,
    ...
    IL_ldc_i4_6, IL_ldc_i4_7, IL_ldc_i4_8, IL_ldc_i4_m1,
    ...
    IL_not, IL_or, IL_rem, IL_shl, IL_shr, IL_shr_un, IL_sub, IL_xor,
    // statements
    IL_disp, IL_repeat, IL_until,
