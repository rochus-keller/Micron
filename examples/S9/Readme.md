...
The S9 virtual machine, implemented originally in C, was translated to Micron
as a representative proof-of-concept of a reasonably big and complex application.
...
Most features are implemented, a few are missing (e.g. store/load images).
