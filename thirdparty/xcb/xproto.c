...
{
    return (xcb_timecoord_t *) (&R->pad1 + 1);
}
...
{
    return (xcb_fontprop_t *) (&R->char_infos_len + 1);
}
...
{
    return (xcb_fontprop_t *) (&R->replies_hint + 1);
}
...
{
    return (xcb_colormap_t *) (&R->pad1 + 1);
}
